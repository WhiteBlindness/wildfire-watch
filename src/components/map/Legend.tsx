import { SEVERITY_COLOR, SEVERITY_LABEL_PT } from "@/lib/wildfire/colors";
...
export default function Legend() {
  return (
    <div className="pointer-events-auto rounded-xl border border-border bg-surface/90 px-3 py-2 shadow-lg backdrop-blur">
      <p className="mb-1.5 text-[10px] font-semibold uppercase tracking-wide text-foreground/50">Severidade</p>
