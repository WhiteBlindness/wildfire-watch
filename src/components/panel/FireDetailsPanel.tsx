  ...
  return (
    <div className="flex h-full flex-col gap-4 p-5">
      ...
      <dl className="grid grid-cols-2 gap-3 text-sm">
        <Stat label="Área ardida" value={`${formatThousands(event.areaHectares)} ha`} />
      ...
      {event.forces && (
        <div className="rounded-lg border border-border bg-surface-muted/50 p-3">
          ...
          <dl className="grid grid-cols-2 gap-3 text-sm">
            <Stat label="Bombeiros" value={formatThousands(event.forces.firefighters)} />
            <Stat label="Veículos" value={formatThousands(event.forces.vehicles)} />
